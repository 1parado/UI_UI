...
export default {
  ...
  theme: {
    extend: {
      ...
      /**
       * Only three intents get motion: a disclosure opening, a panel sliding
       * in from an edge, and an overlay fading. Everything else is instant.
       * Every consumer pairs these with `motion-reduce:animate-none`.
       */
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
